...
impl PyMessage {
    pub fn to_core(&self) -> nova_ai_core::Message {
        let role = match self.role.as_str() {
            "system" => nova_ai_core::Role::System,
            "assistant" => nova_ai_core::Role::Assistant,
            "tool" => nova_ai_core::Role::Tool,
            _ => nova_ai_core::Role::User,
        };
        nova_ai_core::Message {
            role,
...
#[pyclass(name = "Config")]
pub struct PyConfig {
    pub inner: nova_ai_core::NovaConfig,
}
...
impl PyConfig {
    ...
    fn new() -> Self {
        Self {
            inner: nova_ai_core::NovaConfig::default(),
        }
    }
...
pub struct PyEventBus {
    pub inner: std::sync::Arc<nova_ai_core::EventBus>,
}
...
impl PyEventBus {
    ...
    fn new() -> Self {
        Self {
            inner: std::sync::Arc::new(nova_ai_core::EventBus::new(true)),
        }
    }
