...
_pkg_version = __import__('json').load(open('../../frontend/package.json'))['version']
add_text(slide, 0.8, 1.3, 5.5, 0.6, f"Current (v{_pkg_version})", font_size=20, color=ACCENT2, bold=True)
