---
title: Code Snippets
description: Copy-paste patterns for common NOVA AI tasks
---

# Code Snippets

Ready-to-use patterns for the most common NOVA AI tasks. Each snippet is self-contained and copy-pasteable.
...
Run with: `nova compose run research_assistant "quantum computing advances"`

## API Server (1 command)

```bash
nova serve --port 8000 --engine ollama --model qwen3:8b
```
...
```bash
docker build -t nova_ai .
docker run -p 8000:8000 nova_ai serve --host 0.0.0.0
```
