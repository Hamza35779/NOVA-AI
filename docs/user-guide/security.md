...
NOVA AI includes a security layer that scans prompts and model outputs for secrets, personally identifiable information (PII), and sensitive file paths. The system is designed to be composable: scanners run as a pipeline, and the `GuardrailsEngine` wrapper drops in front of any inference backend without changing how the rest of your code works.
...
=== "Block mode"
    ...
    from nova_ai.engine.ollama import OllamaEngine
    from nova_ai.security.guardrails import GuardrailsEngine, SecurityBlockError
    from nova_ai.security.types import RedactionMode
    from nova_ai.core.types import Message, Role
...
from nova_ai.security.guardrails import GuardrailsEngine
from nova_ai.security.scanner import SecretScanner
from nova_ai.security.types import RedactionMode
...
from nova_ai.security.scanner import PIIScanner
...
from nova_ai.security.file_policy import is_sensitive_file, filter_sensitive_paths
...
from nova_ai.security.audit import AuditLogger
from nova_ai.security.guardrails import GuardrailsEngine
from nova_ai.security.types import RedactionMode
from nova_ai.engine.ollama import OllamaEngine
...
audit = AuditLogger(db_path="~/.nova_ai/audit.db", bus=bus)
...
import time
from nova_ai.security.audit import AuditLogger
from nova_ai.security.types import SecurityEvent, SecurityEventType
...
audit = AuditLogger(db_path="~/.nova_ai/audit.db")
...
Security settings live in the `[security]` section of `~/.nova_ai/config.toml`.
...
secret_scanner = true
pii_scanner = true
audit_log_path = "~/.nova_ai/audit.db"
...
| `audit_log_path` | `str` | `~/.nova_ai/audit.db` | Path to the SQLite audit log |
...
from nova_ai.security.types import ScanFinding, ScanResult, ThreatLevel
...
- [API Reference: Security](../api-reference/nova_ai/security/index.md) — full class and function signatures
