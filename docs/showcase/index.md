...
The Showcase grows from real users. If you've built something interesting on top of NOVA AI — or just have a configuration you're proud of — the format is simple and the bar is low:
...
4. **"How I set this up →"**: a link to the relevant [Tutorial](../tutorials/index.md), [User Guide](../user-guide/cli.md), or [Recipe](https://github.com/Hamza35779/NOVA-AI/tree/main/src/nova_ai/recipes/data).
...
Open a [discussion or issue](https://github.com/Hamza35779/NOVA-AI/issues) on GitHub to share your setup, ask "how would I do X?", or browse what others have built.
