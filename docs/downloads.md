---
title: Downloads
description: Download the NOVA AI desktop app, browser app, CLI, or Python SDK
---
...
by Apple. If you see **"NOVA AI is damaged and can't be opened"**, run this in
...
```bash
xattr -cr ~/Downloads/NOVA AI.app
```
