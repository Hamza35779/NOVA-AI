...
from nova_ai.mining._constants import DEFAULT_PEARL_MODEL
...
class PearlModelSpec:
    """NOVA AI support metadata for a Pearl-compatible model."""
...
PEARL_MODEL_SPECS: tuple[PearlModelSpec, ...] = (
    ...
    PearlModelSpec(
        ...
        notes=(
            ...
            "NOVA AI before mining is enabled by default."
        ),
    ),
    PearlModelSpec(
