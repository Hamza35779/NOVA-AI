...
called from your app startup:
    ...
    from nova_ai.agents.proactive_agent import register_cron
...
def _build_notification_channel(channel_spec: str) -> Optional[Any]:
    ...
    if channel_type == "imessage":
        from nova_ai.channels._stubs import (
            BaseChannel,
            ChannelStatus,
        )
        ...
        class _IMessageShim(BaseChannel):
            ...
            def send(
                ...
                from nova_ai.channels.imessage_daemon import send_imessage
...
class ProactiveAgent(ToolUsingAgent):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        from nova_ai.tools.channel_tools import ChannelSendTool
        from nova_ai.tools.digest_collect import DigestCollectTool
        from nova_ai.tools.proactive_tools import (
            CheckPermissionTool,
