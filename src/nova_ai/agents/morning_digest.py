...
from nova_ai.agents.digest_store import DigestArtifact, DigestStore
...
def _load_persona(persona_name: str) -> str:
    ...
    search_paths = [
        Path("configs/nova_ai/prompts/personas") / f"{persona_name}.md",
...
class MorningDigestAgent(ToolUsingAgent):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self._persona = kwargs.pop("persona", "nova")
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        evaluator_feedback = ""
        try:
            from nova_ai.agents.digest_evaluator import DigestEvaluator
