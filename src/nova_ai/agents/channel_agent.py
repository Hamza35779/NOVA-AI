...
Routes incoming :class:`~nova_ai.channels._stubs.ChannelMessage` objects
...
from nova_ai.channels._stubs import BaseChannel, ChannelMessage
...
_ESCALATION_TEMPLATE = "{preview}...\n\n---\nFull report ready — open in NOVA AI:\nnova_ai://research/{session_id}"
...
class ChannelAgent:
    ...
    agent:
        ...
        method (typically a :class:`~nova_ai.agents._stubs.BaseAgent`
        subclass).
    max_workers:
