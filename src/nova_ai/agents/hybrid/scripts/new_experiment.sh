...
# src/nova_ai/agents/hybrid/registry/<method>.toml
...
#
# Then run:
#   python -m nova_ai.agents.hybrid.runner --cell <printed name>
...
echo "Run with: python -m nova_ai.agents.hybrid.runner --cell ${name}"
