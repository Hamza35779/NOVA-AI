...
from nova_ai.agents.hybrid._base import (
...
from nova_ai.agents.hybrid.mini_swe_agent import (
    _clone_repo,
    _extract_diff,
    run_swe_agent_loop,
)
...
# Map the orchestrator's `model` slot to a concrete NOVA AI worker spec.
...
def _call_tavily_search(
    ...
    Token counts are reported as zero (no LLM was billed); the NOVA AI
...
_MODAL_APP_NAME = "nova_ai-toolorchestra-sandbox"
