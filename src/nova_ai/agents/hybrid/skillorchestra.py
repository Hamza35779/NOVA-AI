...
scope for the NOVA AI port (and was out of scope in the hybrid harness).
...
from nova_ai.agents.hybrid._base import LocalCloudAgent
from nova_ai.agents.hybrid._prices import supports_temperature
