...
if TYPE_CHECKING:
    from nova_ai.core.types import ToolSpec  # noqa: F401
...
def load_mcp_tools_from_config(
    ...
    *,
    ...
    """
    # ``enabled`` and ``servers`` come from nova_ai.core.config's
    ...
    # Imported lazily so that `nova_ai.mcp.loader` can be imported
