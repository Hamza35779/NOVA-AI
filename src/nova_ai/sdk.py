"""High-level Python SDK for NOVA AI."""
...
class MemoryHandle:
    ...
    def _get_backend(self) -> Any:
        ...
        if not MemoryRegistry.contains(key):
            ...
            try:
                from nova_ai.tools.storage.sqlite import SQLiteMemory  # noqa: F401
            except ImportError:
                pass
...
class Nova:
    ...
    def version(self) -> str:
        """Return the NOVA AI version string."""
        return nova_ai.__version__
    ...
    def _run_agent(
        ...
        *,
        ...
        if tools:
            ...
            from nova_ai.cli.ask import _build_tools
        ...
        if agent_name == "morning_digest" and hasattr(self._config, "digest"):
            ...
            from nova_ai.tools.digest_collect import DigestCollectTool
            from nova_ai.tools.text_to_speech import TextToSpeechTool
        ...
        if context and self._config.agent.context_from_memory:
            try:
                from nova_ai.cli.ask import _get_memory_backend
...
__all__ = ["Nova", "NovaSystem", "MemoryHandle", "SystemBuilder"]
