...
Single source of truth for every event name and property the NOVA AI
...
see :mod:`nova_ai.analytics.redaction` for the value-level filters.
...
_SPECS: tuple[EventSpec, ...] = (
    ...
    EventSpec(
        ...
        description="`nova init` finished and config.toml was written.",
        properties={
