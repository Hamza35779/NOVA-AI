...
The internal bus (:mod:`nova_ai.core.events`) carries dozens of
...
from nova_ai.core.events import Event, EventType
    ...
    def _on_tool_end(self, event: Event) -> None:
        try:
            ...
            if first:
                ...
                from nova_ai.analytics.events import KNOWN_TOOL_NAMES
