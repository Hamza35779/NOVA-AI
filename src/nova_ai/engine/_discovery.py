...
def _make_engine(key: str, config: NovaConfig) -> InferenceEngine:
...
def _maybe_register_mining_sidecar_engine() -> None:
    ...
    from nova_ai.engine._openai_compat import _OpenAICompatibleEngine
...
def discover_engines(config: NovaConfig) -> List[Tuple[str, InferenceEngine]]:
