...
_OUTPUT_START = "---NOVA_AI_OUTPUT_START---"
_OUTPUT_END = "---NOVA_AI_OUTPUT_END---"
...
class ContainerRunner:
    ...
    ----------
    image:
        Docker image to run.  Defaults to ``nova_ai-sandbox:latest``.
    timeout:
    ...
    DEFAULT_IMAGE = "nova_ai-sandbox:latest"
    DEFAULT_TIMEOUT = 300
