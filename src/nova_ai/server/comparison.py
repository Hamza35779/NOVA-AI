...
<title>NOVA AI — Cost Comparison</title>
<style>
...
<div class="header">
  <h1><span>NOVA AI</span> Cost Comparison</h1>
  <div class="nav">
...
<div class="container">
  ...
  <div class="hero">
    ...
    <div class="sub">
      NOVA AI runs models on your own hardware. Every inference call that would
  ...
  <div class="calc-section">
    ...
    <div class="calc-results">
      <div class="calc-card free">
        <div class="cc-label">NOVA AI</div>
  ...
  <div class="cta">
    ...
    <div class="cta-sub">Install NOVA AI and run AI locally
...
document.getElementById('copy-btn').addEventListener('click', () => {
  const cmd = 'git clone https://github.com/Hamza35779/NOVA-AI'
    + '.git && cd NOVA-AI && uv sync';
