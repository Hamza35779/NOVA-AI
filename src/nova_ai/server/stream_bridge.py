...
from nova_ai.agents._stubs import AgentContext, BaseAgent
from nova_ai.core.events import Event, EventBus, EventType
    ...
    async def stream(self) -> AsyncGenerator[str, None]:
        ...
        try:
            ...
            try:
                ...
                logger = logging.getLogger("nova_ai.server")
            ...
            if engine is not None and hasattr(engine, "stream_full") and content:
                ...
                try:
                    from nova_ai.core.types import Message as MsgType
                    from nova_ai.core.types import Role as RoleType
                    ...
                    _logger = _logging.getLogger("nova_ai.server")
                    _logger.warning(
