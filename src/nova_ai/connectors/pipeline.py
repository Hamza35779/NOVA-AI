...
from nova_ai.connectors._stubs import Attachment, Document
from nova_ai.connectors.chunker import SemanticChunker
...
if TYPE_CHECKING:
    from nova_ai.connectors.attachment_store import AttachmentStore
