...
def create_energy_monitor(
    ...
    try:
        from nova_ai.telemetry.energy_nvidia import NvidiaEnergyMonitor
    ...
    try:
        from nova_ai.telemetry.energy_amd import AmdEnergyMonitor
    ...
    try:
        from nova_ai.telemetry.energy_apple import AppleEnergyMonitor
    ...
    try:
        from nova_ai.telemetry.energy_rapl import RaplEnergyMonitor
