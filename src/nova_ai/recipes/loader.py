...
Recipes are the universal composition format for NOVA AI.  Each recipe
...
class Recipe:
    ...
    def to_builder_kwargs(self) -> Dict[str, Any]:
        """Convert recipe fields to kwargs for SystemBuilder/Nova.

        Returns a dict with only the non-None fields, keyed to match
        the SystemBuilder fluent API or Nova constructor parameters.
        """
        kwargs: Dict[str, Any] = {}
    ...
    def to_eval_suite(
        ...
        """
        from nova_ai.recipes.composer import recipe_to_eval_suite
    ...
    def to_operator_manifest(self) -> Any:
        ...
        from nova_ai.recipes.composer import recipe_to_operator
...
def discover_recipes(
    ...
    *,
    ...
    3. User ``~/.nova_ai/recipes/`` directory
    4. User ``~/.nova_ai/operators/`` directory
