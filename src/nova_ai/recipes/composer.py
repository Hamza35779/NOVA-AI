...
if TYPE_CHECKING:
    from nova_ai.evals.core.types import EvalSuiteConfig
    from nova_ai.operators.types import OperatorManifest
    from nova_ai.recipes.loader import Recipe
...
def recipe_to_eval_suite(
    ...
    backend = recipe.eval_backend or ("nova-agent" if has_agent else "nova-direct")
