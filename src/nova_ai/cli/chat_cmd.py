"""``nova chat`` — interactive multi-turn chat REPL."""
...
def chat(
    ...
    # Resolve engine
    from nova_ai.engine import get_engine
    from nova_ai.intelligence import register_builtin_models
    ...
    if agent_key and agent_key != "none":
        try:
            import nova_ai.agents  # noqa: F401 — trigger registration
    ...
    # Print banner
    console.print(
        f"[green bold]NOVA AI Chat[/green bold]\n"
    ...
    from nova_ai.cli._chat_notifications import NotificationDispatcher
