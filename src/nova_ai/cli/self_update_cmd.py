"""`nova self-update` — upgrade NOVA AI to the latest release.
...
@click.command(
    "self-update",
    help=(
        "Upgrade NOVA AI to the latest release. Detects how you "
...
def self_update(check: bool, yes: bool) -> None:
    ...
    click.echo(f"Current NOVA AI version: v{current}")
    ...
    click.echo("\nUpgrade complete. Re-run `nova --version` to confirm.")
