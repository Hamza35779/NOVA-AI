"""``nova serve`` — OpenAI-compatible API server."""
...
def serve(
        ...
        try:
            ...
            if AgentRegistry.contains(agent_key):
                ...
                if getattr(agent_cls, "accepts_tools", False):
                    import nova_ai.tools  # noqa: F401  # trigger registration
            ...
            try:
                ...
                if AgentRegistry.contains(channel_agent):
                    ...
                    if getattr(_ch_cls, "accepts_tools", False):
                        ...
                        from nova_ai.mcp.loader import (
                        ...
                        # NovaSystem below; we extend its lifetime by
    ...
    # block so the executor's NovaSystem can reference it (#263).
    memory_backend = None
    ...
    from nova_ai.core.credentials import TOOL_CREDENTIALS, get_credential_status
    ...
    console.print(
        f"[green]Starting NOVA AI API server[/green]\n"
