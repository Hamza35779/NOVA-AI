"""Startup banner — NOVA AI wordmark + tagline."""

from __future__ import annotations

# "NOVA AI" rendered in the figlet "standard" font. Stored as plain text
...
def print_banner(quiet: bool = False) -> None:
    """Print the NOVA AI startup banner. No-op when quiet."""
    if quiet:
        return
    try:
