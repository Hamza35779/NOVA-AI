"""LLM-based optimizer for NOVA AI configuration tuning.

Uses a cloud LLM to propose optimal NOVA AI configs, inspired by DSPy's
...
from nova_ai.evals.core.types import RunSummary
...
class LLMOptimizer:
    """Uses a cloud LLM to propose optimal NOVA AI configs.
    ...
    def _build_initial_prompt(self) -> str:
        ...
        lines: List[str] = []
        lines.append("You are optimizing an NOVA AI AI system configuration.")
        lines.append("")
    ...
    def _build_analyze_prompt(
        ...
        lines: List[str] = []
        lines.append("Analyze this NOVA AI evaluation result.")
        lines.append("")
