...
Adapted from IPW's ``environment.py``.  Uses NOVA AI's
:class:`~nova_ai.tools._stubs.ToolExecutor` for real tool dispatch
...
class OrchestratorEnvironment:
    """RL environment that executes tools via NOVA AI ``ToolExecutor``.
