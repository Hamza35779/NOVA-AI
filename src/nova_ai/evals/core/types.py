...
class RunConfig:
    ...
    # the NovaConfig.agent.max_turns value (typically 10). Set higher when
...
class ExecutionConfig:
    ...
    # to NovaConfig.agent.max_turns (default 10). Bump to 30-50 for
