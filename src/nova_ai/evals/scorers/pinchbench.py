...
Provides transcript translation (NOVA AI events → PinchBench format),
...
from nova_ai.evals.core.event_recorder import EventType
...
# ---------------------------------------------------------------------------
# Tool name mapping: NOVA AI name → PinchBench-expected name
# ---------------------------------------------------------------------------
...
def _tool_results_to_transcript(
    ...
    """Build transcript from NovaAgentBackend tool_results list."""
    transcript: List[Dict[str, Any]] = []
