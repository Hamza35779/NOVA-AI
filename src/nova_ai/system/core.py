"""NovaSystem — the fully wired system dataclass."""
...
if TYPE_CHECKING:
    ...
    from nova_ai.channels._stubs import BaseChannel
    ...
    from nova_ai.security.boundary import BoundaryGuard
    ...
    from nova_ai.speech._stubs import SpeechBackend
...
class NovaSystem:
    ...
    def wire_channel(self, channel_bridge: Any) -> None:
        ...
        ----------
        channel_bridge:
            A connected :class:`~nova_ai.channels._stubs.BaseChannel`
