...
|---|---|---|
| **Windows (Desktop installer)** | Double-click `NOVA.AI_1.2.9_x64-setup.exe` — desktop GUI incl. **Alt+Space Quick Capture**; for the no-Python full backend use the portable zip | [Latest Release](https://github.com/Hamza35779/NOVA-AI/releases) |
