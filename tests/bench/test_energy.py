...
from nova_ai.bench.energy import EnergyBenchmark
from nova_ai.core.registry import BenchmarkRegistry
from nova_ai.telemetry.energy_monitor import EnergySample


@pytest.fixture(autouse=True)
def _register_energy():
    """Re-register energy benchmark after registry clear."""
    from nova_ai.bench.energy import ensure_registered
