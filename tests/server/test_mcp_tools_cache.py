...
def test_returns_tools_from_mcp_server(mock_load_config: MagicMock):
    ...
    with (
        patch("nova_ai.mcp.transport.StreamableHTTPTransport"),
        patch("nova_ai.mcp.client.MCPClient"),
