...
from nova_ai.server.app import create_app  # noqa: E402
...
class TestChatCompletions:
    ...
    def test_instrumented_engine_unwrapped_to_avoid_dual_telemetry(self):
        ...
        from nova_ai.core.types import TOKEN_COUNTING_VERSION
...
class TestIdentityPromptInjection:
    ...
    saw NOVA AI's identity system prompt and the model answered from its
    ...
    def test_stream_injects_identity_when_absent(self):
        ...
        assert "NOVA AI" in msgs[0].content
