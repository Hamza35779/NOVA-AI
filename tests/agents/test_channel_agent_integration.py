...
from nova_ai.agents.channel_agent import ChannelAgent
...
def test_quick_query_inline_response(tmp_path: Path) -> None:
    ...
    containing calendar info and NO nova_ai:// link.
    """
    ...
    assert "nova_ai://" not in sent_content, (
...
def test_deep_query_escalation_link(tmp_path: Path) -> None:
    ...
    assert "nova_ai://" in sent_content, (
