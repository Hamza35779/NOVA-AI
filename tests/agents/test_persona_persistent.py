"""Persona files reach persistent agents, not just one-shot `nova ask` (#376).

SOUL.md / MEMORY.md / USER.md are loaded by `nova ask` via SystemPromptBuilder.
...
from nova_ai.core.config import MemoryFilesConfig, SystemPromptConfig
