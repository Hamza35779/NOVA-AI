...
class TestDefaults:
    def test_nova_config_defaults(self) -> None:
        cfg = NovaConfig()
...
class TestTomlLoading:
    ...
    def test_system_prompt_block_parsed(self, tmp_path: Path) -> None:
        ...
        cfg = load_config(toml_file)
        assert cfg.system_prompt.prefix == "You are Nova."
...
class TestSecurityConfig:
    ...
    def test_security_config_on_nova_config(self) -> None:
        cfg = NovaConfig()
...
class TestChannelConfig:
    ...
    def test_channel_config_on_nova_config(self) -> None:
        cfg = NovaConfig()
...
class TestAgentConfigNew:
    ...
    def test_default_system_prompt_anchors_identity(self) -> None:
        """#540: the hardened wording must name NOVA AI and explicitly
...
class TestSandboxConfig:
    def test_defaults(self) -> None:
        ...
        assert sc.image == "nova_ai-sandbox:latest"
    ...
    def test_on_nova_config(self) -> None:
        cfg = NovaConfig()
...
class TestApplyTomlSectionListNormalization:
    def test_apply_toml_section_list_to_str_field(self) -> None:
        ...
        from nova_ai.core.config import ToolsConfig, _apply_toml_section
    ...
    def test_apply_toml_section_list_to_property_setter(self) -> None:
        ...
        from nova_ai.core.config import _apply_toml_section
