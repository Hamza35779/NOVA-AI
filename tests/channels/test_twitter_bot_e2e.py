...
class TestClassifyMentionDispatch:
    ...
    def test_valid_labels_pass_through(self, llm_label, expected):
        ...
        assert _classify_mention("some tweet", nova=j) == expected
    ...
    def test_defaults_to_question_if_model_returns_other(self):
        ...
        assert _classify_mention("hahaha", nova=j) == "QUESTION"
...
# =========================================================================
# 1c. Prompt-injection detector (unit, mocked Nova)
# =========================================================================
...
class TestPromptBuilders:
    ...
    def test_bug_prompt_contains_github_url(self):
        ...
        assert "api.github.com/repos/Hamza35779/NOVA-AI/issues" in prompt
...
class TestMentionPolling:
    ...
    def test_poll_dispatches_to_handler(self):
            ...
            "data": [
                {
                    "id": "111",
                    "author_id": "alice",
                    "text": "@nova_ai_demo how do I install?",
                    "conversation_id": "111",
                },
            ],
        }
        ...
        assert msg.content == "@nova_ai_demo how do I install?"
...
class TestEnvVarExpansion:
    ...
    def test_github_token_expanded(self):
        ...
        with (
            ...
            patch("nova_ai.tools.http_request.check_ssrf", return_value=None),
            patch(
                "nova_ai.tools.http_request.httpx.request",
...
# =========================================================================
# 5. Full reactive e2e flow (mock Nova + TwitterChannel)
# =========================================================================
...
class TestFullE2EFlow:
    ...
    def _make_mock_nova(self, responses=None):
        """Create a mock Nova instance that returns canned responses."""
        j = MagicMock()
        if responses:
    ...
    def test_question_flow(self):
        ...
        """
        j = self._make_mock_nova(["check the docs at hamza35779.github.io"])
        tweet = DEMO_TWEETS[0]
    ...
    def test_bug_report_flow(self):
        ...
        j = self._make_mock_nova(["opened an issue for this"])
        tweet = DEMO_TWEETS[1]
    ...
    def test_praise_flow(self):
        ...
        j = self._make_mock_nova(["thanks, glad you like it!"])
        tweet = DEMO_TWEETS[3]
        mention_type = "PRAISE"
    ...
    def test_spam_is_ignored(self):
        """Spam mentions should be skipped — no Nova.ask call."""
        j = self._make_mock_nova()
    ...
    def test_all_demo_tweets_processed(self):
        ...
        TestClassifyMentionDispatch against a mocked nova. This test
...
class TestGitHubIssueCreation:
    ...
    def test_create_bug_issue(self):
        ...
        mock_resp.text = json.dumps(
            {
                "number": 42,
                "html_url": "https://github.com/Hamza35779/NOVA-AI/issues/42",
            }
        )
        mock_resp.headers = {"content-type": "application/json"}
        ...
        with (
            ...
            patch("nova_ai._rust_bridge.get_rust_module", return_value=mock_rust),
            patch("nova_ai.tools.http_request.check_ssrf", return_value=None),
            patch(
                "nova_ai.tools.http_request.httpx.request",
                return_value=mock_resp,
