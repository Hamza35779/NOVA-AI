...
class TestOuraLive:
    def test_sync_returns_documents(self):
        from nova_ai.connectors.oura import OuraConnector
...
class TestStravaLive:
    def test_sync_returns_documents(self):
        from nova_ai.connectors.strava import StravaConnector
...
class TestSpotifyLive:
    def test_sync_returns_documents(self):
        from nova_ai.connectors.spotify import SpotifyConnector
...
class TestGoogleTasksLive:
    def test_sync_returns_documents(self):
        from nova_ai.connectors.google_tasks import GoogleTasksConnector
