...
def connector(tmp_path: Path):
    ...
    from nova_ai.connectors.gmail import GmailConnector  # noqa: PLC0415
...
@patch("nova_ai.connectors.gmail._gmail_api_list_messages")
@patch("nova_ai.connectors.gmail._gmail_api_get_message")
...
def test_html_to_text_strips_basic_tags() -> None:
    ...
    from nova_ai.connectors.gmail import _html_to_text  # noqa: PLC0415
