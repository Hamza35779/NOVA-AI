...
def connector(tmp_path: Path):
    ...
    from nova_ai.connectors.gdrive import GDriveConnector  # noqa: PLC0415
...
@patch("nova_ai.connectors.gdrive._gdrive_api_list_files")
@patch("nova_ai.connectors.gdrive._gdrive_api_export")
