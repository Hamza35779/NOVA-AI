...
def connector(tmp_path: Path):
    ...
    from nova_ai.connectors.dropbox import DropboxConnector  # noqa: PLC0415
...
@patch("nova_ai.connectors.dropbox._dropbox_api_list_folder")
@patch("nova_ai.connectors.dropbox._dropbox_api_download")
