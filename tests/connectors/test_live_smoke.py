...
NOT mocked. Uses the actual NOVA AI docs/ directory as an Obsidian-like vault.
...
# Use the real NOVA AI docs directory
...
def test_live_obsidian_full_pipeline() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        try:
            ...
            # B4 fix: close store + engine so Windows can clean TemporaryDirectory
            # (open SQLite handle otherwise raises PermissionError WinError 32).
            try:
                store.close()
            except Exception:
                pass
