...
_LOCAL_CONNECTORS = [
    ("apple_notes", "nova_ai.connectors.apple_notes", "AppleNotesConnector"),
    ("imessage", "nova_ai.connectors.imessage", "IMessageConnector"),
]

_TOKEN_CONNECTORS = [
    ("gmail_imap", "nova_ai.connectors.gmail_imap", "GmailIMAPConnector"),
    ("outlook", "nova_ai.connectors.outlook", "OutlookConnector"),
    ("slack", "nova_ai.connectors.slack_connector", "SlackConnector"),
    ("notion", "nova_ai.connectors.notion", "NotionConnector"),
    ("granola", "nova_ai.connectors.granola", "GranolaConnector"),
    ("gdrive", "nova_ai.connectors.gdrive", "GDriveConnector"),
    ("gcalendar", "nova_ai.connectors.gcalendar", "GCalendarConnector"),
    ("gcontacts", "nova_ai.connectors.gcontacts", "GContactsConnector"),
    ("dropbox", "nova_ai.connectors.dropbox", "DropboxConnector"),
]
