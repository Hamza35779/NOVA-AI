...
def connector(tmp_path: Path):
    ...
    from nova_ai.connectors.gcalendar import GCalendarConnector  # noqa: PLC0415

    creds_path = str(tmp_path / "gcalendar.json")
    with patch(
        "nova_ai.connectors.oauth._SHARED_GOOGLE_CREDENTIALS_PATH",
...
@patch("nova_ai.connectors.gcalendar._gcal_api_calendars_list")
@patch("nova_ai.connectors.gcalendar._gcal_api_events_list")
