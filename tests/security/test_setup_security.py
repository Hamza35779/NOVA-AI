...
from nova_ai.core.config import CapabilitiesConfig, NovaConfig, SecurityConfig
from nova_ai.core.events import EventBus
from nova_ai.security import SecurityContext, setup_security
...
def _make_config(*, enabled: bool = True, caps_enabled: bool = False) -> NovaConfig:
    cfg = NovaConfig()
