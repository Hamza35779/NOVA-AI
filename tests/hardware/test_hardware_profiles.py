...
class TestDetectHardware:
    ...
    @patch("nova_ai.core.config.shutil.which", return_value="/usr/bin/nvidia-smi")
    @patch(
        "nova_ai.core.config._run_cmd",
    ...
    @patch("nova_ai.core.config.shutil.which", return_value="/usr/bin/rocm-smi")
    @patch(
        "nova_ai.core.config._run_cmd",
        side_effect=[
    ...
    @patch("nova_ai.core.config.platform.system", return_value="Darwin")
    @patch(
        "nova_ai.core.config._run_cmd",
        return_value=(
            "Graphics/Displays:\n"
    ...
    @patch("nova_ai.core.config.shutil.which", return_value=None)
    @patch("nova_ai.core.config.platform.system", return_value="Linux")
