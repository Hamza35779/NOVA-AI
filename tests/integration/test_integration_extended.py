...
class TestOpenHandsPipeline:
    ...
    def test_openhands_code_execution_e2e(self):
        _register_all()
        from nova_ai.agents.native_openhands import NativeOpenHandsAgent
        from nova_ai.tools.code_interpreter import (
            CodeInterpreterTool,
        )
...
class TestMCPIntegration:
    ...
    def test_mcp_server_with_all_tools(self):
        ...
        from nova_ai.mcp.transport import InProcessTransport
        from nova_ai.tools.calculator import CalculatorTool
        from nova_ai.tools.think import ThinkTool
    ...
    def test_mcp_unknown_tool_error(self):
        from nova_ai.mcp.client import MCPClient
        from nova_ai.mcp.protocol import MCPError
        from nova_ai.mcp.server import MCPServer
        from nova_ai.mcp.transport import InProcessTransport
        from nova_ai.tools.calculator import CalculatorTool
...
class TestModelCatalogIntegration:
    ...
    def test_all_models_routable(self):
        ...
        from nova_ai.intelligence.model_catalog import (
            BUILTIN_MODELS,
        )
