...
from nova_ai.telemetry.energy_rapl import (
    RaplEnergyMonitor,
    _discover_domains,
)
...
# Fake domain dirs are named like the real sysfs layout ("intel-rapl:0"),
# and ':' is not a legal filename character outside Linux.
pytestmark = pytest.mark.skipif(
    sys.platform != "linux",
    reason="RAPL sysfs layout (colon-suffixed domain dirs) is Linux-only",
)

_PLAT = "nova_ai.telemetry.energy_rapl.platform.system"
_BASE = "nova_ai.telemetry.energy_rapl._RAPL_BASE"
