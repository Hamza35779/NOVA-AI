...
from nova_ai.core.registry import CompressionRegistry
...
def _register_compressors():
    ...
    from nova_ai.sessions.compression import (
        ModelSummarization,
...
def test_rule_based_strips_tool_boilerplate():
    from nova_ai.sessions.compression import RuleBasedPrecompression
...
def test_session_consolidation_preserves_recent():
    from nova_ai.sessions.compression import SessionConsolidation
...
def test_tiered_summaries_gradient():
    from nova_ai.sessions.compression import TieredSummaries
