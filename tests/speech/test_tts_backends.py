...
from nova_ai.core.registry import TTSRegistry
from nova_ai.speech.tts import TTSResult
...
def test_cartesia_registered():
    from nova_ai.speech.cartesia_tts import CartesiaTTSBackend
...
def test_cartesia_synthesize():
    ...
    with patch(
        "nova_ai.speech.cartesia_tts._cartesia_synthesize",
...
def test_kokoro_registered():
    from nova_ai.speech.kokoro_tts import KokoroTTSBackend
...
def test_openai_tts_registered():
    from nova_ai.speech.openai_tts import OpenAITTSBackend
...
def test_openai_tts_synthesize():
    ...
    with patch(
        "nova_ai.speech.openai_tts._openai_tts_request",
