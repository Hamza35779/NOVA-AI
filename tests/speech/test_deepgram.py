...
from nova_ai.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_transcribe():
    ...
    with patch("nova_ai.speech.deepgram.DeepgramClient", return_value=mock_client):
        from nova_ai.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_health():
    with patch("nova_ai.speech.deepgram.DeepgramClient"):
        from nova_ai.speech.deepgram import DeepgramSpeechBackend
