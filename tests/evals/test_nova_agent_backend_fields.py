"""Verify NovaAgentBackend.generate_full returns the spec §6.2 extended fields."""
...
class TestNovaAgentExtendedFields:
    def test_generate_full_includes_framework_and_commit(self) -> None:
        ...
        with patch("nova_ai.system.SystemBuilder") as MockSB:
            ...
            backend = NovaAgentBackend(model="qwen-9b")
            ...
            assert result["framework"] == "nova_ai"
