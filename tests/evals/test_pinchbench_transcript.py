...
from nova_ai.evals.core.event_recorder import AgentEvent, EventType
from nova_ai.evals.core.trace import TurnTrace
...
def test_events_to_transcript_tool_call_pair():
    ...
    from nova_ai.evals.scorers.pinchbench import events_to_transcript
...
def test_events_to_transcript_tool_name_mapping():
    """NOVA AI tool names are mapped to PinchBench-expected names."""
    from nova_ai.evals.scorers.pinchbench import events_to_transcript
