...
- NovaDirectBackend propagates gpu_metrics flag
...
from nova_ai.evals.core.types import EvalResult, RunConfig, RunSummary
...
class TestSummaryToDict:
    ...
    def test_telemetry_summary_present(self):
        from nova_ai.evals.core.runner import _summary_to_dict
...
class TestResultToTraceDict:
    ...
    def test_estimated_flops_in_trace(self):
        from nova_ai.evals.core.runner import _result_to_trace_dict
...
# ---------------------------------------------------------------------------
# NovaDirectBackend gpu_metrics propagation
# ---------------------------------------------------------------------------


class TestDirectBackendGpuMetrics:
    """Verify NovaDirectBackend sets gpu_metrics on config."""
...
class TestTauBenchTelemetryPassthrough:
    ...
    @patch("nova_ai.evals.execution.taubench_env.TauBenchTaskEnv")
...
class TestExpandSuiteModelMetadata:
    ...
    def test_metadata_includes_params(self):
        from nova_ai.evals.core.config import expand_suite
        from nova_ai.evals.core.types import (
            BenchmarkConfig,
            DefaultsConfig,
            EvalSuiteConfig,
            ExecutionConfig,
