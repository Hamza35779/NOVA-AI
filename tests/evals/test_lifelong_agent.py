...
class TestDBEnvironment:
    def test_multi_turn_select(self) -> None:
        ...
        from nova_ai.evals.environments.lifelong_agent_env import DBEnvironment
...
class TestKGEnvironment:
    def test_multi_turn_with_oracle(self) -> None:
        ...
        from nova_ai.evals.environments.lifelong_agent_env import KGEnvironment
...
class TestOSEnvironment:
    def test_requires_docker(self) -> None:
        ...
        from nova_ai.evals.environments.lifelong_agent_env import OSEnvironment
...
class TestCLI:
    def test_in_benchmarks(self) -> None:
        from nova_ai.evals.cli import BENCHMARKS
...
class TestMaxTurns:
    def test_db_max_turns(self) -> None:
        from nova_ai.evals.environments.lifelong_agent_env import (
            MAX_TURNS_DB,
            DBEnvironment,
        )
