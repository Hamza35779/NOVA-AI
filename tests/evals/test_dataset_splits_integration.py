...
PROVIDERS = [
    ("nova_ai.evals.datasets.pinchbench", "PinchBenchDataset"),
    ("nova_ai.evals.datasets.liveresearch", "LiveResearchBenchDataset"),
    ("nova_ai.evals.datasets.gaia", "GAIADataset"),
    ("nova_ai.evals.datasets.liveresearchbench", "LiveResearchBenchDataset"),
    ("nova_ai.evals.datasets.taubench", "TauBenchDataset"),
    ("nova_ai.evals.datasets.toolcall15", "ToolCall15Dataset"),
    ("nova_ai.evals.datasets.livecodebench", "LiveCodeBenchDataset"),
]
