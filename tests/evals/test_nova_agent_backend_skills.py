"""Tests for NovaAgentBackend skills_enabled / overlay_dir kwargs (Plan 2B)."""
...
class TestNovaAgentBackendSkillsKwargs:
    ...
    def test_init_signature_accepts_kwargs_without_engine(self):
        ...
        sig = inspect.signature(NovaAgentBackend.__init__)
