...
PROVIDERS = [
    ("nova_ai.evals.datasets.adp", "ADPDataset"),
    ("nova_ai.evals.datasets.toolorchestra", "ToolOrchestraDataset"),
    ("nova_ai.evals.datasets.generalthoughts", "GeneralThoughtsDataset"),
]
