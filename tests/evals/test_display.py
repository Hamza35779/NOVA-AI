"""Tests for the Rich display helpers in nova_ai.evals.core.display."""
...
from nova_ai.evals.core.types import MetricStats, RunSummary
...
class TestPrintBanner:
    def test_produces_output(self):
        ...
        output = buf.getvalue()
        assert "NOVA AI" in output or "___" in output
