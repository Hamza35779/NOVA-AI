"""Tests for nova_ai.optimize.trial_runner module."""

from __future__ import annotations

from unittest.mock import MagicMock, patch

from nova_ai.evals.core.types import RunConfig, RunSummary
from nova_ai.learning.optimize.trial_runner import TrialRunner
from nova_ai.learning.optimize.types import TrialConfig, TrialResult
...
class TestRunTrial:
    ...
    @patch("nova_ai.evals.cli._build_scorer")
    @patch("nova_ai.evals.cli._build_judge_backend")
    @patch("nova_ai.evals.cli._build_dataset")
    @patch("nova_ai.evals.cli._build_backend")
    @patch("nova_ai.evals.core.runner.EvalRunner")
    ...
    def test_run_trial_populates_sample_scores(
        ...
        from nova_ai.evals.core.types import EvalResult
