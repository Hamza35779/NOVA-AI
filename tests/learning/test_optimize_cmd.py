"""Smoke tests for ``nova optimize`` and ``nova feedback`` CLI commands,
...
class TestOptimizeConfig:
    """Tests for OptimizeConfig in NovaConfig."""

    def test_optimize_config_in_nova_config(self):
        from nova_ai.core.config import NovaConfig, OptimizeConfig
    ...
    def test_optimize_config_defaults(self):
        from nova_ai.core.config import OptimizeConfig
