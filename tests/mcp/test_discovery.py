...
_PATCH_HTTP = "nova_ai.mcp.transport.StreamableHTTPTransport"
_PATCH_STDIO = "nova_ai.mcp.transport.StdioTransport"
_PATCH_CLIENT = "nova_ai.mcp.client.MCPClient"
_PATCH_PROVIDER = "nova_ai.tools.mcp_adapter.MCPToolProvider"
_PATCH_LOGGER = "nova_ai.system.builder.logger"
