"""Regression tests for nova_ai.mcp.loader.load_mcp_tools_from_config.
...
def _mock_mcp_stack():
    ...
    with (
        patch("nova_ai.mcp.client.MCPClient") as MockClient,
        patch("nova_ai.mcp.transport.StreamableHTTPTransport") as MockHttp,
        patch("nova_ai.mcp.transport.StdioTransport") as MockStdio,
        patch("nova_ai.tools.mcp_adapter.MCPToolProvider") as MockProvider,
    ):
