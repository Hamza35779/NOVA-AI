...
REAL_WORLD_MENTIONS = [
    # === QUESTIONs that should ground (docs cover them) ===
    {
        ...
        "text": (
            "@nova_ai_demo does this work with vllm or "
    ...
    },
    {
        ...
        "author": "indie_hacker",
        "text": (
            "@nova_ai_demo can I run the orchestrator agent "
    ...
    },
    {
        ...
        "author": "macuser",
        "text": "@nova_ai_demo how do I install on macos with apple silicon?",
    },
    {
        "id": "3000000000000000004",
        "author": "longwinded_lou",
        "text": (
            "@nova_ai_demo how does the memory system handle "
    ...
    # === QUESTIONs that should defer (off-topic / unknowable) ===
    {
        ...
        "text": "@nova_ai_demo what's the weather in tokyo today?",
    },
    {
        "id": "3000000000000000006",
        "author": "specific_specs",
        "text": (
            "@nova_ai_demo what's the exact tokens-per-second "
    ...
    # === BUG / FEATURE / PRAISE / SPAM ===
    {
        ...
        "author": "devops_dan",
        "text": (
            "@nova_ai_demo getting a segfault on startup "
    ...
    },
    {
        ...
        "text": (
            "@nova_ai_demo any plans for SSO support? "
    ...
    },
    {
        ...
        "author": "convert_carl",
        "text": (
            "@nova_ai_demo switched from langchain last week, this is incredible"
        ),
    },
    {
        "id": "3000000000000000010",
        "author": "crypto_bro",
        "text": "@nova_ai_demo BUY $NOVA COIN guaranteed 10x gains link in bio",
    },
]
...
def main():
    ...
    j = Nova(model=model, engine_key="ollama")
