...
TOPICS = [
    # Narrative — opinionated takes that happen to be about NOVA AI
    ...
    "open source Apache license community research",
...
FACTS = [
    ...
    "Local language models can accurately service most single-turn chat and reasoning queries at interactive latencies, and their capability per watt keeps improving year over year.",
    "In nearly all personal AI projects today, the local component is a thin orchestration layer, while the brain lives in someone else data center. Your most personal data routes through cloud APIs, with their latency, their cost, and their terms of service. We built NOVA AI to fix this.",
    "NOVA AI is structured around five composable primitives: Intelligence, Engine, Agents, Tools and Memory, and Learning. Each primitive can be benchmarked, substituted, and optimized independently.",
    "NOVA AI includes hardware-agnostic telemetry that profiles energy consumption across NVIDIA GPUs, AMD GPUs, and Apple Silicon. Energy and dollar cost are first-class design constraints alongside accuracy.",
...
def main() -> None:
    ...
    j = Nova(model="qwen3:32b", engine_key="ollama")
    j._config.agent.max_turns = 5

    # Clean and index
    db_path = os.path.expanduser("~/.nova_ai/memory.db")
    ...
    parent_ts = slack_send(
        "*NOVA AI Twitter Bot — Overnight Preview*\n"
    ...
    while True:
        ...
        tool_log.clear()
        r = j.ask_full(
            "You are @nova_ai_demo — a researcher/dev who believes local-first "
            ...
            'server. we built nova_ai to fix that"\n'
            ...
            "Link: https://github.com/Hamza35779/NOVA-AI",
            agent="orchestrator",
