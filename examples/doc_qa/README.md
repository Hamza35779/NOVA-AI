...
Index a directory of documents into NOVA AI memory and answer questions
...
1. **Index** -- Uses `Nova.memory.index()` to chunk the documents at
...
NOVA AI SDK. Adjust `--chunk-size` and `--top-k` to tune the
