...
from nova_ai.core import open_browser

CONFIG_DIR = Path.home() / ".nova_ai" / "connectors"
...
GOOGLE_CLIENT_ID = (
    os.environ.get("NOVA_AI_GOOGLE_CLIENT_ID", "") or _google["client_id"]
)
GOOGLE_CLIENT_SECRET = (
    os.environ.get("NOVA_AI_GOOGLE_CLIENT_SECRET", "")
    or _google["client_secret"]
)

_strava = _load_creds("strava.json")
STRAVA_CLIENT_ID = (
    os.environ.get("NOVA_AI_STRAVA_CLIENT_ID", "") or _strava["client_id"]
)
STRAVA_CLIENT_SECRET = (
    os.environ.get("NOVA_AI_STRAVA_CLIENT_SECRET", "")
    or _strava["client_secret"]
)

_spotify = _load_creds("spotify.json")
SPOTIFY_CLIENT_ID = (
    os.environ.get("NOVA_AI_SPOTIFY_CLIENT_ID", "") or _spotify["client_id"]
)
SPOTIFY_CLIENT_SECRET = (
    os.environ.get("NOVA_AI_SPOTIFY_CLIENT_SECRET", "")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run OAuth flows for NOVA AI connectors"
    )
