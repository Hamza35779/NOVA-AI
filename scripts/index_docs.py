#!/usr/bin/env python3
"""Index NOVA AI docs (README.md + docs/**/*.md) into a DenseMemory backend.
...
def build_index(
    ...
    *,
    ...
    dedupe: bool = True,
    # Empirical: on the actual NOVA AI docs the boilerplate that
    # crowds retrieval ("NOVA AI runs entirely on your hardware...")
...
def main() -> int:
    ...
    queries = args.query or [
        ...
        "what inference engines does nova_ai support?",
