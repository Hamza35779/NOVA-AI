...
const OPTIN_KEY = 'nova_ai-desktop-optin';
const OPTIN_NAME_KEY = 'nova_ai-desktop-display-name';
const OPTIN_EMAIL_KEY = 'nova_ai-desktop-email';
const OPTIN_ANONID_KEY = 'nova_ai-desktop-anon-id';
    ...
    <div style={styles.container}>
      ...
      {showOptIn ? (
        ...
        <div style={{ marginBottom: 16, display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <a
            href="https://hamza35779.github.io/NOVA-AI/leaderboard"
            target="_blank"
