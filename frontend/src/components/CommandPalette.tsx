...
const CLOUD_PROVIDERS: CloudProvider[] = [
  ...
  },
  {
    ...
    storageKey: 'nova_ai-anthropic-key',
    models: [
  ...
  },
  {
    ...
    storageKey: 'nova_ai-openrouter-key',
    models: [
      ...
      >
        ...
        >
          {tab === 'installed' ? (
            ...
            <span>API keys are stored locally and never sent to NOVA AI servers</span>
          )}
        </div>
      </div>
    </div>
