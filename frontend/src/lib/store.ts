...
const CONVERSATIONS_KEY = 'nova_ai-conversations';
const SETTINGS_KEY = 'nova_ai-settings';
const OPTIN_KEY = 'nova_ai-optin';
const OPTIN_NAME_KEY = 'nova_ai-display-name';
const OPTIN_EMAIL_KEY = 'nova_ai-email';
const OPTIN_ANONID_KEY = 'nova_ai-anon-id';
const OPTIN_SEEN_KEY = 'nova_ai-optin-seen';
...
interface Settings {
  theme: ThemeMode;
  apiUrl: string;
  // Local server API key (NOVA_AI_API_KEY). Sent as a Bearer token on
